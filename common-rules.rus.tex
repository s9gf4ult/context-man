...
\subject{Принудительный разрыв страницы}

Обычно, \c сам разбивает текст на страницы, но иногда требуется приказать \c
начать новую страницу. Для этого есть команда \tex{page}. Давайте попробуем ей
воспользоваться
