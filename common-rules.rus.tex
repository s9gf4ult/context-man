...
документы, о чем \c пояснит в сообщении.
...
команды \tex{placefigure}, которая имеет два обязатльных аргумента.

Необязательные аргументы заключаются в
...
заголовке. Если нужно в конкретном месте изменить вырванивание используются
...
\startalignment[width,stretch,nohyphenation]
...
чтобы избежать выхода текста за границы параграфа. Может быть
